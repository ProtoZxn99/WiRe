...
$query = mysqli_query($conn, "update timer set grouping_id = ".$grouping_id.", timer_name = '".$timer_name."', timer_start = '".$timer_start."', timer_state = '".$timer_state."', timer_d0 = ".$timer_d0.", timer_d1 = ".$timer_d1.", timer_d2 = ".$timer_d2.", timer_d3 = ".$timer_d3.", timer_d4 = ".$timer_d4.", timer_d5 = ".$timer_d5.", timer_d6 = ".$timer_d6." where timer_id = ".$timer_id.";");
