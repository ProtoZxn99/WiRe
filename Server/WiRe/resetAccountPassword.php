...
if($exec['users']>0){
    ...
    $url = "http://".$ip_wire."/WiRe/FormAccountPasswordChange.php?account_email=".hash("sha256",$header_salt.$account_user.$end_salt);
    ...
    sendeMail("wire@noreply.com", $account_user, "Reset WiRe Password", $msg."<a href ='".$url."'>".$img."</a>".$closure);
    echo 1;
}
else{
