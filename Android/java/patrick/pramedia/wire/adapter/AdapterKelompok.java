...
public class AdapterKelompok extends RecyclerView.Adapter<AdapterKelompok.MyViewHolder>  {
...
//        private ImageView menu;
        ...
        public MyViewHolder(View view) {
            ...
            lg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ik.click(MyViewHolder.this.getLayoutPosition());
                }
            });
            lg.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public boolean onLongClick(View v) {
                    ajax_hapus(g.getServer() + "deleteGrouping.php", listKelompok.get(MyViewHolder.this.getLayoutPosition()).getId_kelompok(), MyViewHolder.this.getLayoutPosition());
                    return false;
                }
            });
        }
    ...
    public AdapterKelompok(List<Kelompok> listData, Context context, RecyclerView rv, interfaceRVKelompok ik) {
